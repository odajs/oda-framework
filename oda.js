...
function ODA(prototype = {}) {
        ...
        prototype.url = matches[matches.length - 1];
            ...
            class odaComponent extends HTMLElement {
                ...
                render(force){
                    ...
                    if(Object.keys(this.$core.saveProps).length){
                        const savePath = this.localName + (this.$core.saveKey?'.'+this.$core.saveKey:'');
                        let save = {};
                        if(force){
        ...
        if (el.nodeType === 3){
            ...
            for (const attr of el.attributes){
                ...
                if (/^(:|bind:)/.test(attr.name)){
                    ...
                    const fn = new Function(params, `with (this) {${expr}}`);
    ...
    Object.defineProperty(Array.prototype, 'clear', { enumerable: false, value: function () {
            this.splice(0);
        }});
    Object.defineProperty(Array.prototype, 'last', { enumerable: false, get () {
            return this[this.length-1];
        }});
    Object.defineProperty(Array.prototype, 'add', { enumerable: false, value: function (...item) {
            for (let i of item){
                if (this.includes(i)) continue;
                this.push(i);
            }
        }});
    Object.defineProperty(Array.prototype, 'remove', { enumerable: false, value: function (...items) {
    ...
    if (!String.toKebabCase) {
        Object.defineProperty(String.prototype, 'toKebabCase', { enumerable: false, value: function () {
    ...
    if (!String.toCamelCase) {
        Object.defineProperty(String.prototype, 'toCamelCase', { enumerable: false, value: function (){
                const s = this.toString();
...
// };
    ...
    ODA.getDirInfo = async function(url){
        ...
        if (!ODA.localDirs){
            try{
                res = await ODA.loadJSON(url+'?get_dirlist');
            }
            catch (e) {
                console.error(e);
            }
    ...
    Object.defineProperty(ODA,  'language', {configurable: false,
        async set(n){
            ODA._language = n;
            try{
                ...
                ODA[('show-'+ id).toCamelCase()] = async function(component, props = {}, hostProps = {}){
                    ...
                    try{
                        return await new Promise((resolve, reject) => {
                            ...
                            window.addEventListener('mousedown', this.mouseEvent, true);
                        })
                    }
                    catch (e){
                        return undefined
                        ...
                        window.removeEventListener('mousedown', this.mouseEvent, true);
                        host.remove();
                    }
                }
            }
